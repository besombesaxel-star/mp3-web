...
export default function MiniPlayer() {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-[calc(60px+env(safe-area-inset-bottom))] sm:bottom-0 left-0 right-0 z-40 sm:border-t sm:border-white/10 sm:bg-black/90 sm:backdrop-blur"
        role="region"
