  ...
  if (promptEvent) {
    return (
      <button
        type="button"
        onClick={install}
        className="fixed left-4 bottom-[calc(env(safe-area-inset-bottom)+150px)] sm:bottom-[84px] z-[90] h-10 px-4 rounded-full border border-white/20 bg-black/85 sm:backdrop-blur text-white/90 text-xs hover:bg-black transition"
  ...
  if (showIosHint) {
    return (
      <div className="fixed left-4 bottom-[calc(env(safe-area-inset-bottom)+150px)] sm:bottom-[84px] z-[90] flex flex-col items-start gap-2">
        {iosHintOpen && (
          <div className="max-w-[240px] rounded-2xl border border-white/15 bg-black/90 px-4 py-3 text-xs leading-relaxed text-white/80 shadow-lg">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="h-10 px-4 rounded-full border border-white/20 bg-black/85 text-white/90 text-xs hover:bg-black transition"
          ...
          <button
            ...
            className="h-8 w-8 shrink-0 rounded-full bg-black/70 text-white/45 flex items-center justify-center hover:text-white/80 transition"
