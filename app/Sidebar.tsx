      ...
      >
        ...
        <div
          className={[
            ...
            compact ? "mb-8 justify-center" : "mb-5 justify-between",
          ].join(" ")}
        >
        ...
        <nav
          className="relative z-10 flex flex-1 min-h-0 flex-col gap-1.5 overflow-y-auto scrollbar-none"
        ...
        <div className="relative z-10 shrink-0 mt-auto pt-3 pb-[76px]">
